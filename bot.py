...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif query.data == 'wallet': await query.edit_message_text("Send: /connect your_wallet_address")
    elif query.data == 'balance': await query.edit_message_text(f"তোমার ব্যালেন্স: {user_data[user_id]['coins']} কয়েন")
    elif query.data == 'lang': await query.edit_message_text("اختر اللغة: /lang ar\n选择语言: /lang zh\nSelect: /lang en /lang bn /lang hi")
